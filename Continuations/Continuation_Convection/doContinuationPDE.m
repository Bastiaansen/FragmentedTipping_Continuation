...
options.parameterMinimum = -10.1;
options.parameterMaximum = -2;
options.parameterIncrement = -0.001;
options.parameterMaxSteps = 10^5; % Maximum number of par. cont. steps

options.trackParameterEachNSteps = 500; % Save how many steps? (als outputted)
